...
<div class="container">
    <h4 class="h4 bg-primary text-white py-3 ps-4 mt-4 mb-0">Data Master Supplier</h4>
    <div class="container border border-gray p-0">

        <div class="d-flex justify-content-end p-3">
            <a href="tambah_supplier.php" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Supplier</a>
        </div>
            ...
            <tbody>
                <?php foreach ($suppliers as $nomor => $data) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_supplier.php?id=<?= $data['id'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                            <a href="hapus_supplier.php?id=<?= $data['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fas fa-trash"></i>Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
